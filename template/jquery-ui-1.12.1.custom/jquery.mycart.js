...
(function ($) {
  ...
  var loadMyCartEvent = function(userOptions){
    ...
    if(!$("#" + idCartModal).length) {
		...
		var str = '<div class="modal fade" id="' + idCartModal + '" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">' +
        ...
        '<table class="table table-hover table-responsive ' + idCartTable + '"></table>' +
        '</div>' +
	  ...
	  //var string='<table class="table table-hover table-responsive" id="' + idCartTab + '"></table>';
	  //window.alert(str);
	  //window.alert(tring);
	  //var tring='<table class="' + idCartTable + '"></table>';
	  
      $('body').append(str);
	  //$('.tab-pane').append(tring);
    }
    ...
    var drawTable = function(){
      ...
      $cartTable.append(products.length ?
        ...
        '<td></td>' +
        '<td></td>' +
        '<td><strong class="' + idGrandTotal + '">$</strong></td>' +
        '<td></td>' +
        '</tr>'
      ...
      if(products.length && discountPrice !== null) {
        $cartTable.append(
          ...
          '<td></td>' +
          '<td></td>' +
          '<td><strong class="' + idDiscountPrice + '">$</strong></td>' +
          '<td></td>' +
          '</tr>'
        );
