...
class Partner extends CI_Controller {
	...
	public function index()
	{
		...
		$data['modulename'] = ucfirst($modulename);
		$data['partner'] = $this->NEWS_Model->AllStories(6,0,$modulename);
		if(sizeof($data['partner'])){
			$this->my_layout->view("partner_view",$data); 
		}else{
	...
	public function module()
	{
		...
		if($p[0]['parentid']==0){
			...
			if(sizeof($pp))
			{
				...
				$data['stories'] = $this->NEW_Model->StoriesCategory($off="",$limit="", $strcat=array())
