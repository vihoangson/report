...
echo'	<div class="panel-heading">
		<h4 class="panel-title">NEWSLETTER&nbsp;</h4><br>
		</div>';
	...
	for($i =0; $i < sizeof($newsletter); $i ++) {
		$id = $newsletter[$i]['id'];
			echo"<tr>
				...
				Bạn có muốn xóa video này: <a class=\"waves-effect waves-button waves-classic\" href=\"".base_url()."index.php/newsletter/deletenewsletter/".$id."\"> Yes</a> - <a class=\"waves-effect waves-button waves-classic\" href=\"#\" onclick=\"myFunctionClose('".$id."')\"> No </a>
				</div>
