...
echo"<form  action=\"".base_url()."index.php/news/saveeditcategories/".$catid."\" method=\"post\" name=\"adminForm\" id=\"adminForm\">";
...
echo"	<table width=\"50%\" border=\"0\"  style=\"padding-left:20px;\">";
	  ...
	  {
		  $xtitle = $this->News_model->getCategoriesLang($catid, $lang[$i]['lang_id']);
		  $title = $xtitle[0]['title'];
			echo "<tr>
			<td height=\"30\"><img src=\"".base_url()."images/".$lang[$i]['flag']."\" /></td>
			<td> <input name=\"txttitle[]\" type=\"text\" size=\"40\" value=\"".$title."\" /><input name=\"lang[]\" type=\"hidden\" value=\"".$lang[$i]['lang_id']."\" /></td>
			</tr>";	
...
echo"	<tr><td height=\"30\" width=\"150\">Thuộc chủ đề:</td><td>";
		echo $show_edit_stories_category;
		echo $select_categories_parent;
echo"	</td></tr>";
