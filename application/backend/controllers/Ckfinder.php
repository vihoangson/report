...
/**
 * [MENTION=20085]Pro[/MENTION]perty CI_Output $output 
 */
class Ckfinder extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->rootCkPath = FCPATH . APPPATH . 'backend/ckfinder/';
    }
    ...
    public function _remap($method, $params = array()) {
        ...
        if (file_exists($this->rootCkPath . $path))
        {
            ...
            else//if ($ext == 'html')
            {
                ...
                $content = file_get_contents (APPPATH . 'backend/ckfinder/' . $path);
